...
class Cell {
  ...
  _mergeStyle(rowStyle, colStyle, style) {
    const numFmt =
      (rowStyle && rowStyle.numFmt) || (colStyle && colStyle.numFmt);
    ...
    const alignment =
      (rowStyle && rowStyle.alignment) || (colStyle && colStyle.alignment);
    if (alignment) style.alignment = alignment;

    const border =
      (rowStyle && rowStyle.border) || (colStyle && colStyle.border);
    ...
    const protection =
      (rowStyle && rowStyle.protection) || (colStyle && colStyle.protection);
...
class FormulaValue {
  ...
  get dependencies() {
    ...
    const ranges = this.formula.match(
